                            ...
                            <div class='col-md-8'>
                                <div class='card m-b-20'>
                                    ...
                                    if(isset($msg)){ ?>
                                        ...
                                        <?=form_open_multipart('proses/tambah_ebook')?>
                                            ...
                                            <div class='form-group'>
                                                ...
                                                <input type="text" autocomplete='off' name='penerbit' class='form-control required' placeholder="">
                                            </div>
                                            <div class='form-group'>
                                                <label>Kota Terbit </label>
                                                <input type="text" autocomplete='off' name='kota' class='form-control required' placeholder="">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class='form-group'>
                                                ...
                                                <input required type="text" autocomplete='off' name='sinopsis' class='form-control required' placeholder="">
                                            </div>
                            ...
                            <div class='col-md-4'>
                                <div class='card mb-20'>
                                    <div class='card-body'>
                                        ...
                                        <p>Pada halaman ini anda dapat menambah ebook</p>                                                                              
                                    </div>
                                </div>
                            </div>
                        </div>
