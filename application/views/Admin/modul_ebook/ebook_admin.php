                        ...
                        <div class="row">
							<div class="col-xl-12">
								<div class="page-title-box">
                                    <h4 class="page-title float-left">List Ebook</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="<?=base_url("admin")?>">Beranda</a></li>
                                        <li class="breadcrumb-item"><a href="">List Ebook</a></li>
                                    </ol>
                        ...
                        <div class='row'>
                                        ...
                                        <table id='datatable' class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width='50%'><center>Judul Ebook</center></th>                                                                                                                                                                                                                                                        
                            ...
                            <div class='col-md-4'>
                                <div class='card mb-20'>
                                    <div class='card-body'>
                                        <a href="<?php echo site_url('admin/tambah_ebook/')?>" class='btn btn-block btn-info'>Tambah Ebook</a>
                                        <br>
                                        <h5 class='card-title'>Informasi</h5>
                                        <p>Pada halaman ini anda dapat melihat list Ebook yang sudah di publish pada Digital Library Unsika</p>                                                                                
                                    </div>
                                </div>
                            </div>
                        </div>
