                        ...
                        <div class="row">
							<div class="col-xl-12">
								<div class="page-title-box">
                                    <h4 class="page-title float-left">Tambah Skripsi</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="<?=base_url("admin")?>">Beranda</a></li>
                                        <li class="breadcrumb-item"><a href="<?=base_url("admin/skripsi_admin")?>">List Skripsi</a></li>
                                        <li class="breadcrumb-item"><a href="#">Tambah Skripsi</a></li>
                                    </ol>
                            ...
                            <div class='col-md-8'>
                                <div class='card m-b-20'>
                                    ...
                                    if(isset($msg)){ ?>
                                        ...
                                        <?=form_open_multipart('proses/tambah_skripsi')?>
                                            ...
                                            <div class='form-group'>
                                                <label>Email </label>
                                                <input type="email" autocomplete='off' name='email' class='form-control required' placeholder="">
                                            </div>
                                            <div class='form-group'>
                                            ...
                                            <div class='form-group'>
                                                ...
                                                <input required type="file" class='dropify' data-file-max-size="10M" name='skripsi'>
                                                <small>*Jenis file PDF dan ukuran file 10MB</small>
                                            </div>
                            ...
                            <div class='col-md-4'>
                                <div class='card mb-20'>
                                    <div class='card-body'>
                                        ...
                                        <p>Pada halaman ini anda dapat menambah skripsi</p>                                                                              
                                    </div>
                                </div>
                            </div>
                        </div>
