...
<body>
	...
	<main>
		<section id="hero_in" class="cart_section">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>SKRIPSI</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
		...
		<div class="filters_listing sticky_horizontal">
			<div class="container">
				<ul class="clearfix ">
					...
					<?=form_open_multipart('proses/search_skripsi') ?>
			...
			<div class="box_list wow">
				<!-- <div class="row no-gutters"> -->
					<div class="col-lg-12">
						...
						<ul>
							<li><?= $j->tahun ?></li>
							<li><a href="<?=site_url('home/detail_skripsi/'.$j->id_skripsi)?>">Baca Selengkapnya</a></li>
						</ul>
					</div>
				</div>
			<!-- </div> -->
